    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <form action="{{ url('/bidan/akun/profil_saya/' . Auth::user()->id) }}" method="POST">
                    @method("PUT")
                    @csrf
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="nomor_hp" id="nomor_hp" placeholder="0" value="{{ Auth::user()->getBidan->nomor_hp }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <form action="{{ url('/admin/akun/profil_saya/ganti_password') }}" method="POST">
                    @method("PUT")
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
